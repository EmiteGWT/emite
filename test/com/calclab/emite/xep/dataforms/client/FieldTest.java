...
public class FieldTest {
    ...
    public void testBasicFieldsParsing() {
        final Field field = Field.singleParse(MockitoEmiteHelper.toXML("<field type='jid-multi' label='People to invite'"
    ...
    public void testOptionsParsing() {
        final Field field = Field.singleParse(MockitoEmiteHelper.toXML("<field type='list-single'"
                + " label='Maximum number of subscribers' var='maxsubs'>"
