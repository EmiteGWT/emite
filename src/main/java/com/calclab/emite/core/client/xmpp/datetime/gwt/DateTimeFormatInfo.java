 ...
 * 
 * <p>
 * Implementors should subclass {@link DefaultDateTimeFormatInfo} so when
...
public interface DateTimeFormatInfo {
    ...
    /**
     * @return an array of the shortest abbreviations for months suitable for
     *         use in a stand-alone context, typically a single character and
    ...
    /**
     * @return an array of month abbreviations, suitable for use in a
     *         stand-alone context.
     */
    ...
    /**
     * @return the day which starts the weekend, as an index into the return
     *         value of {@link #weekdaysFull()}.
     */
    int weekendEnd();

    /**
     * @return the day which ends the weekend, as an index into the return value
     *         of {@link #weekdaysFull()}. Note that this value may be
     *         numerically less than {@link #weekendEnd()} - for example,
     *         {@link #weekendEnd()} of 6 and {@link #weekendStart()} of 0 means
